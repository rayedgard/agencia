...
$idioma = new Idioma();
$evento = new Evento();
$titulo = "Gesti&oacute;n y Administraci&oacute;n de eventos";
...
if(isset($_REQUEST['action']))
{
	...
	switch($action)
	{
		case 'actualizar':
			$evento->__SET('id',         $id);
			$evento->__SET('nombre',     $_REQUEST['nombre']);
			$evento->__SET('detalle',     $_REQUEST['detalle']);
			$evento->__SET('mapa',     $_REQUEST['mapa']);
			$evento->__SET('fechaEvento',    $_REQUEST['fechaEvento']);
			   ...
			   if (!((strpos($tipo_archivo1, "gif") || strpos($tipo_archivo1, "png") || strpos($tipo_archivo1,"jpeg") || strpos($tipo_archivo1,"jpg")  && ($tamano_archivo1 < 3000000)))) 
				{ 
					echo "La extensión o el tamaño del archivo de IMAGEN no es correcta. <br><br><table><tr><td><li>Se permiten archivos *.gif, *.png o *.jpg<br><li>se permiten archivos de 3Mb maximo.</td></tr></table><br>";
					  ...
					  $evento->__SET('foto', $nombre_archivo1);
					...
					if(is_uploaded_file($nombre_temporal1)){
						...
						if($_REQUEST['foto1']!=null or $_REQUEST['foto1']!="")
							unlink("images/evento/".$_REQUEST['foto1']);
					}
		    ...
		    {
		    	$evento->__SET('foto',  $_REQUEST['foto1']);
		    }



		    
			$evento->__SET('idioma_id',     $_REQUEST['idioma_id']);
			$evento->__SET('estado', $_REQUEST['estado']);
					...
					<h3 class="blank1"><?php echo $titulo;?></h3>
						...
						<div class="tab-pane active" id="horizontal-form" >
							<div class="bs-example4" data-example-id="contextual-table">
								...
								<form class="form-horizontal" action="index.php?p=<?php echo urlencode(encripta($p,'rayedgard'));?>&action=<?php echo $evento->id > 0 ?  urlencode(encripta("actualizar","rayedgard")) :  urlencode(encripta("registrar","rayedgard")); ?>&id=<?php echo urlencode(encripta($evento->id,'rayedgard'));?>" method="post" enctype="multipart/form-data">

									
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">Nombre del evento</label>
											<div class="col-sm-8">

														
												<!--CAMBIO EN name y value-->
												<input type="text" name="nombre" value="<?php echo $evento->__GET('nombre'); ?>" class="form-control1" id="focusedinput" placeholder="Escriba un nombre de evento de medida" title="Escriba nombre de evento" required="">										
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<!--CAMBIO EN name y value-->
												<textarea  name="detalle"  id="txtarea3"  class="form-control1"><?php echo $evento->__GET('detalle'); ?></textarea> 								
									  ...
									  <div class="form-group">
											...
											<div class="col-sm-8">
												...
												<!--CAMBIO EN name y value-->
												<textarea  name="mapa"  id="txtarea2"  class="form-control1"><?php echo $evento->__GET('mapa'); ?></textarea> 								
										...
										<div class="form-group">
							              ...
							              <div class="col-sm-8">
							              	<input type="date" name="fechaEvento" value="<?php echo $evento->__GET('fechaEvento'); ?>" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
							              </div>
							            </div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input  type="file" name="foto" id="exampleInputFile" value="<?php echo $evento->__GET('foto'); ?>" >												
												<input type="hidden" name="MAX_FILE_SIZE" value="900000">
												<p class="help-block">Formatos PNG, JPG, GIF.</p>
												<input type="text" name="foto1" id="exampleInputFile" value="<?php echo $evento->__GET('foto'); ?>" hidden/>
											</div>	

											<div class="col-sm-4">

												 <img src="images/evento/<?php echo $evento->__GET('foto');  ?>" height="60" width="60"/> 
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												foreach($idioma->ListarCombo() as $r): ?>		
									                    ...
									                    <option name="idioma_id" value="<?php echo $r->__GET('id'); ?>" <?php echo $evento->__GET('idioma_id') == $r->__GET('id') ? 'selected/' : ''; ?>><?php echo $r->__GET('nombre'); ?>
									                    </option >
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<div class="radio block">
													<!--CAMBIO EN name y value-->												
													<label><input type="radio" name="estado"  value="1" <?php if(null ===$evento->__GET('estado')) echo 'checked'; if($evento->__GET('estado')==1) echo  'checked' ; else echo ''; ?> > Activo </label>
														
													<!--CAMBIO EN name y value-->
													<label><input type="radio" name="estado" value="0" <?php if(null !==$evento->__GET('estado')) {
														if($evento->__GET('estado')==0) echo  'checked';  else echo '';
														}  ?> >  Inactivo</label>
												</div>
						...
						<div class="bs-example4" data-example-id="contextual-table">
							<table class="table">
							  ...
							  <tbody>
								...
								<?php 
								$cont=1;
								foreach($evento->Listar('evento') as $r): ?>
			                        <tr <?php echo $r->__GET('estado') == 1 ? 'class="colorrowactivo"' : 'class="colorinactivo"'    ?>>
			                        	<td><?php echo $cont++; ?></td>
			                            <td><?php echo $r->__GET('nombre'); ?></td>
			                            <td><?php echo $r->__GET('fechaEvento'); ?></td>
			                            
			                        	 <td>
			                       			<img src="images/evento/<?php echo $r->__GET('foto');  ?>" height="30" width="30"/> 
			                             </td>
