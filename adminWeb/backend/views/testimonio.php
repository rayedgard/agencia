<?php
require_once 'models/Testimonio.php';
...
$titulo = "Gesti&oacute;n y Administraci&oacute;n de testimonios";
...
if(isset($_REQUEST['action']))
{
	...
	{
		case 'actualizar':
			$testimonio->__SET('id',         $id);
			$testimonio->__SET('nombre',     $_REQUEST['nombre']);
			$testimonio->__SET('correo',     $_REQUEST['correo']);
			$testimonio->__SET('fecha',    date('Y-m-d'));
			$testimonio->__SET('detalle',     $_REQUEST['detalle']);
			   ...
			   if (!((strpos($tipo_archivo1, "gif") || strpos($tipo_archivo1, "png") || strpos($tipo_archivo1,"jpeg") || strpos($tipo_archivo1,"jpg")  && ($tamano_archivo1 < 3000000)))) 
				{ 
					echo "La extensión o el tamaño del archivo de IMAGEN no es correcta. <br><br><table><tr><td><li>Se permiten archivos *.gif, *.png o *.jpg<br><li>se permiten archivos de 3Mb maximo.</td></tr></table><br>";
					  ...
					  $testimonio->__SET('foto', $nombre_archivo1);
					...
					if(is_uploaded_file($nombre_temporal1)){
						...
						if($_REQUEST['foto1']!=null or $_REQUEST['foto1']!="")
							unlink("images/testimonio/".$_REQUEST['foto1']);
					}
		    ...
		    {
		    	$testimonio->__SET('foto',  $_REQUEST['foto1']);
		    }



		    
			$testimonio->__SET('idioma_id',     $_REQUEST['idioma_id']);
			$testimonio->__SET('estado', $_REQUEST['estado']);
			...
			$testimonio->Actualizar($testimonio);
		...
		case 'registrar':
			...
			$testimonio->Registrar($testimonio);
			//header('Location: index.php');
			/*/------------PARA LAS ACCIONES-----------------/*/ 			
			echo "<meta http-equiv ='refresh' content='0;url=index.php?p=". urlencode(encripta($p,'rayedgard'))."'>"; 			/*/------------FIN ACCIONES-----------------/*/
			break;
					...
					<h3 class="blank1"><?php echo $titulo;?></h3>
						...
						<div class="tab-pane active" id="horizontal-form" >
							<div class="bs-example4" data-example-id="contextual-table">
								...
								<form class="form-horizontal" action="index.php?p=<?php echo urlencode(encripta($p,'rayedgard'));?>&action=<?php echo $testimonio->id > 0 ?  urlencode(encripta("actualizar","rayedgard")) :  urlencode(encripta("registrar","rayedgard")); ?>&id=<?php echo urlencode(encripta($testimonio->id,'rayedgard'));?>" method="post" enctype="multipart/form-data">

									
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">Nombre del testimoniante</label>
											<div class="col-sm-8">

														
												<!--CAMBIO EN name y value-->
												<input type="text" name="nombre" value="<?php echo $testimonio->__GET('nombre'); ?>" class="form-control1" id="focusedinput" placeholder="Escriba un nombre de testimonio de medida" title="Escriba nombre de testimonio" required="">										
									    ...
									    <div class="form-group">
											...
											<div class="col-sm-8">
												...
												<!--CAMBIO EN name y value-->
												<input type="text" name="correo" value="<?php echo $testimonio->__GET('correo'); ?>" class="form-control1" id="focusedinput" placeholder="Escriba un correo " title="Escriba correo" required="">										
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input  type="file" name="foto" id="exampleInputFile" value="<?php echo $testimonio->__GET('foto'); ?>" >												
												<input type="hidden" name="MAX_FILE_SIZE" value="900000">
												<p class="help-block">Formatos PNG, JPG, GIF.</p>
												<input type="text" name="foto1" id="exampleInputFile" value="<?php echo $testimonio->__GET('foto'); ?>" hidden/>
											</div>	

											<div class="col-sm-4">

												 <img src="images/testimonio/<?php echo $testimonio->__GET('foto');  ?>" height="60" width="60"/> 
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<!--CAMBIO EN name y value-->
												<textarea  name="detalle"  id="txtarea3"  class="form-control1"><?php echo $testimonio->__GET('detalle'); ?></textarea> 								
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												foreach($idioma->ListarCombo() as $r): ?>		
									                    ...
									                    <option name="idioma_id" value="<?php echo $r->__GET('id'); ?>" <?php echo $testimonio->__GET('idioma_id') == $r->__GET('id') ? 'selected/' : ''; ?>><?php echo $r->__GET('nombre'); ?>
									                    </option >
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<div class="radio block">
													<!--CAMBIO EN name y value-->												
													<label><input type="radio" name="estado"  value="1" <?php if(null ===$testimonio->__GET('estado')) echo 'checked'; if($testimonio->__GET('estado')==1) echo  'checked' ; else echo ''; ?> > Activo </label>
														
													<!--CAMBIO EN name y value-->
													<label><input type="radio" name="estado" value="0" <?php if(null !==$testimonio->__GET('estado')) {
														if($testimonio->__GET('estado')==0) echo  'checked';  else echo '';
														}  ?> >  Inactivo</label>
												</div>
						...
						<div class="bs-example4" data-example-id="contextual-table">
							<table class="table">
							  ...
							  <tbody>
								...
								<?php 
								$cont=1;
								foreach($testimonio->Listar('testimonio') as $r): ?>
			                        <tr <?php echo $r->__GET('estado') == 1 ? 'class="colorrowactivo"' : 'class="colorinactivo"'    ?>>
			                            ...
			                            <td><?php echo $r->__GET('correo'); ?></td>
			                        	 <td>
			                       			<img src="images/testimonio/<?php echo $r->__GET('foto');  ?>" height="30" width="30"/> 
			                             </td>
