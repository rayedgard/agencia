...
if(isset($_REQUEST['action']))
{
	...
	switch($action)
	{
		case 'registrar':
			...
			$banner->__SET('subcategoria_id', $idd);
			...
			echo "<meta http-equiv ='refresh' content='0;url=banner.php?idd=". urlencode(encripta($idd,'rayedgard'))."&n=".urlencode(encripta($nombre,'rayedgard'))." '>"; 	
					/*/------------FIN ACCIONES-----------------/*/
			break;
		...
		case 'eliminar':
			...
			if($nombreFoto!=null or $nombreFoto!="")
				unlink("../images/bannerPaquete/".$nombreFoto); //elimina en la carpeta
			break;
					...
					<h3 class="blank1"><?php echo $titulo;?></h3>
						...
						<div class="tab-pane active" id="horizontal-form" >
							<div class="bs-example4" data-example-id="contextual-table">
								...
								<form class="form-horizontal" action="banner.php?action=<?php echo urlencode(encripta("registrar","rayedgard")); ?>&idd=<?php echo urlencode(encripta($idd,'rayedgard'));?>&n=<?php echo urlencode(encripta($nombre,'rayedgard'));?>" method="post" enctype="multipart/form-data">
						...
						<div class="bs-example4" data-example-id="contextual-table">
							<table class="table">
							  ...
							  <tbody>
								...
								<?php 
								$cont=1;
								foreach($banner->Listar($idd) as $r): ?>
			                        <tr>
			                        	<td><?php echo $cont++; ?></td>
			                            <td><?php echo $r->__GET('titulo'); ?></td>
			                            <td><?php echo $r->__GET('detalle'); ?></td>
			                        	 <td>
			                       			<img src="../images/bannerPaquete/<?php echo $r->__GET('foto');  ?>" height="30" width="30"/> 
			                             </td>
