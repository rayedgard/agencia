...
if(isset($_REQUEST['action']))
{
	...
	switch($action)
	{
		case 'registrar':
			...
			$galeria->__SET('subcategoria_id', $idd);
			...
			echo "<meta http-equiv ='refresh' content='80;url=galeria.php?idd=". urlencode(encripta($idd,'rayedgard'))."&n=".urlencode(encripta($nombre,'rayedgard'))." '>"; 	
			/*/------------FIN ACCIONES-----------------/*/
			break;
		...
		case 'eliminar':
			...
			if($nombreFoto!=null or $nombreFoto!="")
				unlink("../images/galeriaPaquete/".$nombreFoto); //elimina en la carpeta
			break;
					...
					<h3 class="blank1"><?php echo $titulo;?></h3>
						...
						<div class="tab-pane active" id="horizontal-form" >
							<div class="bs-example4" data-example-id="contextual-table">
								...
								<form class="form-horizontal" action="galeria.php?action=<?php echo urlencode(encripta("registrar","rayedgard")); ?>&idd=<?php echo urlencode(encripta($idd,'rayedgard'));?>&n=<?php echo urlencode(encripta($nombre,'rayedgard'));?>" method="post" enctype="multipart/form-data">
								...
								foreach($galeria->Listar($idd) as $r): ?>
			                        <tr>
			                            ...
			                            <td><?php echo $r->__GET('nombre'); ?></td>
			                        	 <td>
			                       			<img src="../images/galeriaPaquete/<?php echo $r->__GET('nombre');  ?>" height="30" width="30"/> 
			                             </td>
