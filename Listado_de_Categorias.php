...
// print_r("CERDO".$idIdiomaTags=$_SESSION["idIdioma"]);
}
		        ...
		        <div class="col-md-8" style=" padding-left: 90px;">
		            <h1 class="page-header sidebar-title">
		                <?php  $listaTagsDestinos=new ControlesTags();
				 			echo $reservas=$listaTagsDestinos->ListarTagsLavelStr($idIdiomaTags,'H4LavelPaquetes','txt_paquetes'); 
							?>
		            </h1>
		            <div>
		            	<?php
		            	...
		            	if (isset($_POST["id_fijo"])) {
		            		...
		            		$arreglo = $subcategorias->ListarPorCategoria($id);
		            		// print_r($arreglo);
...
// ; " id="7" class="linkDestino" value="Machu Picchu"><input type="text" style="visibility:hidden" name="id_fijo" value="7"></h2> <p style="color: #000">visita obligada "uñas" un viaje a Perú, Machu Picchu es un sitio realmente extraordinario.&nbsp;Normalmente nos gusta abusar del uso de superlativos, pero esta vez la palabra no es robado.&nbsp;Lo que lo ha</p> </div> </div> <br> <hr></form>
		            		# code...
		            	}
		            ...
		            <aside class="col-md-4 sidebar-padding">
		                ...
		                <div class="blog-sidebar">
		                    <h4 class="sidebar-title"><i class="fa fa-list-ul"></i> <?php  $listaTagsDestinos=new ControlesTags();
				 			echo $reservas=$listaTagsDestinos->ListarTagsLavelStr($idIdiomaTags,'H2LavelDestinos','txt_reserva'); ?></h4>
		                    <hr>
		                    <div id="div_reservas">					
